...
export function AppShell({ children }: { children: ReactNode }) {
  ...
  useEffect(() => { setMobileTabState(savedTab); }, [savedTab]);
  ...
  useEffect(() => { setGalleryViewState(savedView); }, [savedView]);
  ...
  const galleryValue = useMemo<GalleryContextValue>(() => ({
    ...
    isDesktop, mobileTab, setMobileTab, galleryView, setGalleryView,
    photos, setPhotos, handlePhotoClick,
    loading, setLoading, hasMore, setHasMore, cursor, setCursor,
    loadingMore, setLoadingMore, refreshPhotos, setRefreshPhotos,
  ]);
